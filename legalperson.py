...
class Crawler():
    ...
    def __init__(self, prefix="legalperson"):
    ...
    def _get_legalperson_data(self, date_str):
        payload = {
                'download': '',
                'qdata': date_str,
                'sorting': 'by_issue'
...
## Nelson: Save page content to file for debug
#tmp_html = open('legalperson.html', 'w')
#tmp_html.write(page.text)
#tmp_html.close()
...
#print tds
    ...
    def get_data(self, year, month, day):
        ...
        self._get_legalperson_data(date_str)
